...
type ActionResult = { success: true; data: Link } | { error: string };
...
export async function updateLinkAction(
  ...
  try {
    const link = await updateLink(validationResult.data.id, userId, {
      originalUrl: validationResult.data.originalUrl,
...
type DeleteActionResult = { success: true } | { error: string };
